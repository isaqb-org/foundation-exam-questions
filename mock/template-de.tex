...
\input{mock-preamble}
\ifstrequal{X{{solutions}}X}{XtrueX}{\solutionstrue}{}
...
\begin{titlepage}
  ...
  Document version: {{documentVersion}}, \builddate\\
...
Die Bearbeitungsdauer beträgt 75 Minuten für Muttersprachler:innen und 90
Minuten für Nicht-Muttersprachler:innen. Um eine möglichst authentische
