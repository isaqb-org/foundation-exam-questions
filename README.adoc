...
Take the mock exam interactively in your browser:                                                                                                 

* https://enyineer.github.io/isaqb-exam/[iSAQB Exam Practice] - community-built exam trainer                                                      
* https://johanneswseitz.codeberg.page/isaqb-foundation-mock-exam/[iSAQB Foundation Mock Exam] - another community practice tool                  
...
The latest release of the Mock exam can be found here:

https://public.isaqb.org/#_examination

== Info

Info on the exam procedure is available in several languages in
directory [`exam-info`](exam-info/).
...
[source,bash]
----
xmllint --relaxng exam.rng <filename> ...
----
